...
def define_handler_scoring(llm_eval: models.KeywordEvaluation,
                           human_agree_with_llm: bool,
                           state_manager: SessionStateManager) -> Callable:
    """
    ...
    def _inner():
        if not human_agree_with_llm:
            state_manager.set('keyword_feedback_eval',
...
def define_handler_save_human_eval(
        ...
        keyword_feedback_eval: models.KeywordEvaluation) -> Callable:
    """
